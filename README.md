...
| [Kitchen AutoCAD + 3D Plan](docs/Kitchen_AutoCAD_3D_Project_Plan.md) | Full high-end kitchen CAD/DXF, BIM/IFC metadata, and 3D review plan | Technical Lead, Production Team |
| [Kitchen Workflow Verification](docs/Kitchen_Workflow_Verification.md) | Evidence, commands, DXF checks, and current GstarCAD COM status | Technical Lead, Production Team |
| [Kitchen 3D Viewer Prototype](src/viewer/kitchen_3d_viewer/README.md) | Static Three.js review scene synchronized to the AutoCAD kitchen planner spec | Technical Lead, Production Team |
